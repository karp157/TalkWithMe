...
public class BluetoothChatService
{
	...
	private synchronized void setState(int state)
	{
		...
		{
			Log.d(MainActivity.TAG, "setState() " + mState + " -> " + state);
		}
		mState = state;
	...
	public synchronized void connect(BluetoothDevice device)
	{
		if (MainActivity.DEBUG)
		{
			Log.d(MainActivity.TAG, "connect to: " + device);
		}
	...
	public synchronized void connected(BluetoothSocket socket, BluetoothDevice device)
	{
		...
		final Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_DEVICE_NAME);
	...
	private void connectionFailed()
	{
		...
		final Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
		final Bundle bundle = new Bundle();
	...
	private class AcceptThread extends Thread
	{
		...
		public AcceptThread()
		{
			...
			{
				Log.e(MainActivity.TAG, "listen() failed", e);
			}
			mmServerSocket = tmp;
		}
		...
		public void run()
		{
			if (MainActivity.DEBUG)
			{
				Log.d(MainActivity.TAG, "BEGIN mAcceptThread" + this);
			}
			...
			while (mState != STATE_CONNECTED)
			{
				...
				{
					Log.e(MainActivity.TAG, "accept() failed", e);
					break;
				}
				...
				if (socket != null)
				{
					synchronized (BluetoothChatService.this)
					{
						...
						case STATE_CONNECTED:
							...
							{
								Log.e(MainActivity.TAG, "Could not close unwanted socket", e);
							}
							break;
						}
					}
			...
			if (MainActivity.DEBUG)
			{
				Log.i(MainActivity.TAG, "END mAcceptThread");
			}
		}
		...
		public void cancel()
		{
			if (MainActivity.DEBUG)
			{
				Log.d(MainActivity.TAG, "cancel " + this);
			}
			try
			{
			...
			{
				Log.e(MainActivity.TAG, "close() of server failed", e);
			}
		}
	}
	...
	private class ConnectThread extends Thread
	{
		...
		public ConnectThread(BluetoothDevice device)
		{
			...
			{
				Log.e(MainActivity.TAG, "create() failed", e);
			}
			mmSocket = tmp;
		}
		...
		public void run()
		{
			Log.i(MainActivity.TAG, "BEGIN mConnectThread");
			...
			catch (final IOException e)
			{
				...
				{
					Log.e(MainActivity.TAG, "unable to close() socket during connection failure", e2);
				}
	...
	private class ConnectedThread extends Thread
	{
		...
		public ConnectedThread(BluetoothSocket socket)
		{
			...
			{
				Log.e(MainActivity.TAG, "temp sockets not created", e);
			}
		...
		public void run()
		{
			Log.i(MainActivity.TAG, "BEGIN mConnectedThread");
